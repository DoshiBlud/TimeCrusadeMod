...
namespace TimeCrusadeMod.Content.Tiles.Banners
{
    ...
    public class EnemyBanner1 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
        {
            WormofNeutralityHead,
        }
    }
    public class EnemyBanner2 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
    ...
    public class EnemyBanner3 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
    ...
    public class EnemyBanner4 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
    ...
    public class EnemyBanner5 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
    ...
    public class EnemyBanner6 : ModBannerTile
    {
        // This enum keeps our code clean and readable.
        // Each enum entry has a numerical value (0, 1, ...) which corresponds to the tile style of the placed banner.
        public enum StyleID
