...
namespace TimeCrusadeMod.Content.Tiles
{
	...
	public class NeutralTorch : ModTile
	{
		...
		public override float GetTorchLuck(Player player) {
			...
			bool inNeutralUndergroundBiome = player.InModBiome<NeutralUndergroundBiome>();
			return inNeutralUndergroundBiome ? 1f : -0.1f; // ExampleTorch gives maximum positive luck when in example biome, otherwise a small negative luck
		}
		...
		public override void EmitParticles(int i, int j, Tile tileCache, short tileFrameX, short tileFrameY, Color tileLight, bool visible) {
			...
			if (Main.rand.NextBool(40) && tileFrameX < 66) {
				int dustChoice = ModContent.DustType<NeutralDust>();
				Dust dust;
