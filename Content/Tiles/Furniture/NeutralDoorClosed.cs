...
{
	// You might have noticed that NeutralDoorClosed.png has 3 copies of the same sprite. These allow for random variation.
	...
	public class NeutralDoorClosed : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileID.Sets.OpenDoorID[Type] = ModContent.TileType<NeutralDoorOpen>();
