...
{
	public class NeutralDoorOpen : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileID.Sets.CloseDoorID[Type] = ModContent.TileType<NeutralDoorClosed>();
			...
			// Tiles usually drop their corresponding item automatically, but RegisterItemDrop is needed here since the NeutralDoor item places NeutralDoorClosed, not this tile.
			RegisterItemDrop(ModContent.ItemType<NeutralDoor>(), 0);
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<NeutralDoor>();
		}
	}
}