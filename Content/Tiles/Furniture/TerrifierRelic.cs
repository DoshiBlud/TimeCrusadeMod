...
namespace TimeCrusadeMod.Content.Tiles.Furniture
{
    ...
    public class TerrifierRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "TimeCrusadeMod/Content/Tiles/Furniture/TerrifierRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "TimeCrusadeMod/Content/Tiles/Furniture/RelicPedestal";
