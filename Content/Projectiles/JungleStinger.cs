...
{
    public class JungleStinger : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.velocity.Y > 9f) // This check implements "terminal velocity". We don't want the projectile to keep getting faster and faster. Past 16f this projectile will travel through blocks, so this check is useful.
            {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Mud, 0f, 0f, 100, default, 1.5f);
            }
        }
