...
{
    public class AxyMagic : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(Projectile.Center, 1, 1, ModContent.DustType<Dusts.AxitrentonDust>(), 0f, 0f, 0, default(Color), 1f);
            dust = Dust.NewDust(Projectile.Center, 1, 1, ModContent.DustType<Dusts.AxitrentonDust>(), 0f, 0f, 0, default(Color), 1f);
        ...
        private const int AlphaFadeInSpeed = 40;
