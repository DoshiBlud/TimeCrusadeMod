...
{
    public class TinyMushroom : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<MushroomDust>(), 0f, 0f, 100, default, 1.5f);
            }
        }
    }
}