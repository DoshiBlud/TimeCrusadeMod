...
{
    public class BungleBomb: ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.penetrate = 2;// Infinite penetration so that the blast can hit all enemies within its radius.
        ...
        public override void AI()
        {
            ...
            if (Projectile.velocity.Y > 17f) // This check implements "terminal velocity". We don't want the projectile to keep getting faster and faster. Past 16f this projectile will travel through blocks, so this check is useful.
            {
