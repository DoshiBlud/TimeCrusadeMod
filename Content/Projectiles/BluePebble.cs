...
{
    public class BluePebble : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.velocity.Y = Projectile.velocity.Y + 0.7f; // 0.1f for arrow gravity, 0.4f for knife gravity
            ...
            {
                int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.BlueTorch, 0f, 0f, 0, default(Color), 1f);
                dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.BlueTorch, 0f, 0f, 0, default(Color), 1f);
