...
namespace TimeCrusadeMod.Content.Projectiles
{
    public class FireBall : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.Flare, 0f, 0f, 0, default(Color), 1f);
                dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.Flare, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.FlameBurst, 0f, 0f, 100, default, 1.5f);
            }
        }
    }
}