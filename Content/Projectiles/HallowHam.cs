...
{
    public class HallowHam: ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.velocity.Y > 18f) // This check implements "terminal velocity". We don't want the projectile to keep getting faster and faster. Past 16f this projectile will travel through blocks, so this check is useful.
            {
            ...
            for (int dusty = 0; dusty < 3; dusty++)
            {
                ...
                dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.YellowTorch, 0f, 0f, 0, default(Color), 1f);
                Main.dust[dust].noGravity = true;
                Main.dust[dust].velocity *= 0.2f;
                Main.dust[dust].scale *= 2f;
            }
            Projectile.rotation = Projectile.velocity.ToRotation() + MathHelper.ToRadians(0f);
            float maxDetectRadius = 580f; // The maximum radius at which a projectile can detect a target
