...
namespace TimeCrusadeMod.Content.Projectiles
{
    ...
    public class AxeofFear : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 110; // The height of projectile hitbox
        ...
        private const int GravityDelay = 32;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                Dust dust = Dust.NewDustDirect(usePos, Projectile.width, Projectile.height, ModContent.DustType<Dusts.GhostDust>());
