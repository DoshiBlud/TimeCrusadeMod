...
{
    public class TerrifiedBone : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.velocity.Y > 10f) // This check implements "terminal velocity". We don't want the projectile to keep getting faster and faster. Past 16f this projectile will travel through blocks, so this check is useful.
            {
                Projectile.velocity.Y = 10f;
            }
            for (int dusty = 0; dusty < 3; dusty++)
            {
                int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.RedTorch, 0f, 0f, 0, default(Color), 1f);
                dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.RedTorch, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Bone, 0f, 0f, 100, default, 1.5f);
            }
        }
