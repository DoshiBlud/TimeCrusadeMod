using TimeCrusadeMod.Backgrounds;
...
{
	public class NeutralUndergroundBiome : ModBiome
	{
		// Select all the scenery
		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.GetInstance<NeutralUndergroundBackgroundStyle>();

		// Select Music
		public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/NeutralBiomeSounds");
        ...
        public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				ModContent.GetInstance<NeutralBiomeTileCount>().NeutralStoneCount >= 450 &&
				ModContent.GetInstance<NeutralBiomeTileCount>().NeutralChiselCount >= 400 &&
				// Limit our biome to be in only the horizontal center third of the world.
				Math.Abs(player.position.ToTileCoordinates().X - Main.maxTilesX / 2) < Main.maxTilesX / 2;
		}
