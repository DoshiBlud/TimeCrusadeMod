...
namespace TimeCrusadeMod.Content.DamageClasses
{
    public class CrafterDamageClass : DamageClass
    {
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<CrafterDamageClass>() += 4;
            player.GetArmorPenetration<CrafterDamageClass>() += 10;
