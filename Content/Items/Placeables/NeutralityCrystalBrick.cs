...
{
	public class NeutralityCrystalBrick : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.NeutralityCrystalBrick>());
			Item.width = 12;
			Item.height = 12;
		}
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<NeutralityCrystal>(), 1)
