...
{
	public class NeutralStoneBrick : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.NeutralStoneBrick>());
			Item.width = 12;
			Item.height = 12;
		}
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<NeutralStone>(), 1)
