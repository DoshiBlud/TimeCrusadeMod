...
{
	public class Decomposer : ModItem
	{
		public override void SetDefaults() {
			// ModContent.TileType<Tiles.Furniture.Decomposer>() retrieves the id of the tile that this item should place when used.
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.Decomposer>());
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ModContent.ItemType<TitraniumBar>(),20)
                .AddCondition(NeutralBiomeCondition.InNeutralBiome)
