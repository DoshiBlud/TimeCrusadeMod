...
{
	public class NeutralChiselBrick : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.NeutralChiselBrick>());
			Item.width = 12;
			Item.height = 12;
		}
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<NeutralChisel>(), 1)
