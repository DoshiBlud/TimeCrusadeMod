...
namespace TimeCrusadeMod.Content.Items.Weapons.Summoner.Minions
{
    ...
    public class WoodenCastlePebble : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Dirt, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, newColor: Color.SkyBlue);
            }
        ...
        public override void OnKill(int timeLeft)
        {
            for (int k = 0; k < 3; k++)
            {
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Stone, Projectile.oldVelocity.X * 0.5f, Projectile.oldVelocity.Y * 0.5f, newColor: Color.SkyBlue);
            }
