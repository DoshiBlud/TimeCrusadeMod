...
namespace TimeCrusadeMod.Content.Items.Weapons.Summoner.Minions
{
    ...
    public class ElementalProtectorBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<ElementalProtector>()] > 0)
            {
    ...
    public class ElementalProtectorStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<ElementalProtectorBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<ElementalProtector>(); // This item creates the minion projectile
        }
    ...
    public class ElementalProtector : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<ElementalProtectorBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<ElementalProtectorBuff>()))
            {
