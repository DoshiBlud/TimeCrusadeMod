...
namespace TimeCrusadeMod.Content.Items.Weapons.Summoner.Minions
{
    ...
    public class BallTerrifierBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<BallTerrifier>()] > 0)
            {
    ...
    public class BallTerrifierStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<BallTerrifierBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<BallTerrifier>(); // This item creates the minion projectile
        }
    ...
    public class BallTerrifier : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.myPlayer == Projectile.owner && foundTarget)
            {
                ...
                int type = ProjectileID.LastPrismLaser;
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<BallTerrifierBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<BallTerrifierBuff>()))
            {
