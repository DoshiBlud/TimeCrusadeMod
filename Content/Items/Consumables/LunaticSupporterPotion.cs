...
{
	public class LunaticSupporterPotion : ModItem
	{
		...
		public override void SetDefaults() {
            ...
            Item.buffTime = 3600;
			Item.potion = true; // The amount of time the buff declared in Item.buffType will last in ticks. 5400 / 60 is 90, so this buff will last 90 seconds.
		}
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<NeutralityBar>(), 1);
