...
namespace TimeCrusadeMod.Content.Items.Accessories
{
    ...
    public class CelestialLifter : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<SoulifiedLifter>());
        ...
        {
            player.GetJumpState<SimpleExtraJump2>().Enable();
        }
    }

    public class SimpleExtraJump2 : ExtraJump
    {
        ...
        {
            Dust dust = Dust.NewDustDirect(spawnPos, player.width, 12, DustID.LunarOre, player.velocity.X * 0.3f, player.velocity.Y * 0.3f, newColor: Color.Gray);
            dust.fadeIn = 1.5f;
