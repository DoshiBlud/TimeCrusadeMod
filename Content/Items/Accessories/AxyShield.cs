...
namespace TimeCrusadeMod.Content.Items.Accessories
{
    ...
    public class AxyShield : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetModPlayer<ExampleDashPlayer2>().DashAccessoryEquipped = true;
        }
    }

    public class ExampleDashPlayer2 : ModPlayer
    {
        public const int DashRight = 2;
        public const int DashLeft = 3;

        public const int DashCooldown = 30; // Time (frames) between starting dashes. If this is shorter than DashDuration you can start a new dash before an old one has finished
        public const int DashDuration = 80; // Duration of the dash afterimage effect in frames

        // The initial velocity.  10 velocity is about 37.5 tiles/second or 50 mph
        public const float DashVelocity = 22f;
