...
{
    public class NecklessoftheAxyConstitute : ModItem
    {
        ...
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(AdditiveDamageBonus, MultiplicativeDamageBonus, BaseDamageBonus, FlatDamageBonus);
    ...
    public class ExampleStatBonusAccessoryPlayer : ModPlayer
    {
        ...
        public override void PostUpdateRunSpeeds()
        {
            ...
            Player.runAcceleration *= 1.7f; // Modifies player run acceleration
            Player.maxRunSpeed *= 1.5f;
            Player.accRunSpeed *= 1.4f;
            Player.runSlowdown *= 1.7f;
        }
    }
}