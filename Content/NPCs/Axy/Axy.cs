    ...
    public class Axy : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                if (attackCounter <= 0 && Vector2.Distance(NPC.Center, targe.Center) > 500 && Collision.CanHit(NPC.Center, 1, 1, targe.Center, 1, 1))
                {
                        Vector2 direction = (targe.Center - NPC.Center).SafeNormalize(Vector2.UnitX);
                        direction = direction.RotatedBy(MathHelper.ToRadians(360));
