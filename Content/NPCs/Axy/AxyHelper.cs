...
namespace TimeCrusadeMod.Content.NPCs.Axy
{
    ...
    public class AxyHelper : ModNPC
    {
        ...
        public override void PostAI()
        {
            ...
            if (attackCounters <= 0 && Vector2.Distance(NPC.Center, target.Center) >= 500 && Collision.CanHit(NPC.Center, 1, 1, target.Center, 1, 1))
            {
                ...
                SoundEngine.PlaySound(SoundID.Item49 with { Pitch = 2 });
                attackCounters = 50;
                NPC.netUpdate = true;
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("The helper of the giant crystal, born from the pieces the being itself.")
            });
        }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0)
            {
                ...
                for (int i = 0; i < 20; i++)
                {
                    ...
                    Dust dust = Dust.NewDustPerfect(NPC.Center, ModContent.DustType<CrystalAxyDust>(), velocity, 26, Color.White, Main.rand.NextFloat(1.5f, 2.4f));

                    dust.noLight = true;
                    dust.noGravity = true;
                    dust.fadeIn = Main.rand.NextFloat(0.3f, 0.8f);
                }
                int frontGoreType = Mod.Find<ModGore>("AxyHelper_Front").Type;
