...
namespace TimeCrusadeMod.Content.NPCs.Enemies.Flying
{
    public class BloodyPiercer : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ItemID.Vertebrae, 4, 1, 1));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<FleshySubstance>(), 5, 1, 2));
        }
        ...
        {
            return spawnInfo.Player.ZoneCrimson ? 0.09f : 0;
        }
