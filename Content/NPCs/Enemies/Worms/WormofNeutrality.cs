	...
	internal class WormofNeutralityHead : WormHead
	{
		...
		public override void SetStaticDefaults() {
			var drawModifier = new NPCID.Sets.NPCBestiaryDrawModifiers() { // Influences how the NPC looks in the Bestiary
				CustomTexturePath = "TimeCrusadeMod/Content/NPCs/Enemies/Worms/WormofNeutrality_Bestiary", // If the NPC is multiple parts like a worm, a custom texture for the Bestiary is encouraged.
