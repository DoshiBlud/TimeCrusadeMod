...
namespace TimeCrusadeMod.Content.NPCs.Terrifier
{
    ...
    internal class TerrifierHead : WormHead
    {
        ...
        public override void ReceiveExtraAI(BinaryReader reader)
        {
            ...
            attackCounter5 = reader.ReadInt32();
        }
                        ...
                        case 5:
                            {
                                ...
                                if (++timer4 < 400) // Wait for the timer to reach 180
                                {
                                    break; // Ending the state early; timer not done yet.
                                }
                                Act = 6;
                        ...
                        case 6:
                            {
                                ...
                                if (attackCounter5 > 0)
                                {
                                    attackCounter5--; // tick down the attack counter.
                                }

                                Player targett = Main.player[NPC.target];
                                if (attackCounter5 <= 4 && Vector2.Distance(NPC.Center, targett.Center) >= 120 && Collision.CanHit(NPC.Center, 1, 1, targett.Center, 1, 1))
                                {
                                ...
                                if (++timer5 < 350) // Wait for the timer to reach 180
                                {
                                    break; // Ending the state early; timer not done yet.
                                }
                                Act = 5;
