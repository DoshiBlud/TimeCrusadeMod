...
namespace TimeCrusadeMod.Common.Configs
{
    public class TimeCrusadeModConfig : ModConfig
    {
        ...
        public bool CelestialDescendentWingsToggle; // To see the implementation of this option, see ExampleWings.cs
