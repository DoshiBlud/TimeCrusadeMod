...
namespace TimeCrusadeMod.Common.EntitySources
{
	...
	public sealed class SourceDependentProjectileTweaks : GlobalProjectile
	{
	...
	public sealed class SourceDependentItemTweaks2 : GlobalItem
	{
		// Always override AppliesToEntity when you can!
